...
class HumanAppointmentsPage extends StatefulWidget {
  ...
  @override
  State<HumanAppointmentsPage> createState() => _HumanAppointmentsPageState();
}

class _HumanAppointmentsPageState extends State<HumanAppointmentsPage> with SingleTickerProviderStateMixin {
                ...
                child: Column(
                  ...
                  children: [
                    _buildDetailSection('Patient Information', [
                      ...
                      _buildDetailRow('Gender', appointment.gender, Icons.person),
